...
- Терминальный лог: В ОБЕИХ темах темнее основного окна (`--term-bg`), остаётся отдельным Command/Inspect-объектом; время — term-muted, приложение — term-text, категория — своим цветом; `love` не использовать как универсальный синтаксический акцент
